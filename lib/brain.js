...
Brain.prototype.validateTier = function validateTier (tier, triggerTx, customerTier, requiredTiers) {
  const requiredManualTiers = _.filter(tier => !_.get(tier, this.trader.triggersAutomation), requiredTiers)
...
Brain.prototype.setManualTrigger = function setManualTrigger (code) {
  if (!_.get(code, this.trader.triggersAutomation)) {
...
/**
 * Clear the rejected bill and keep its amount as the lastRejectedBillFiat
 *
 * @name clearBill
 * @function
 *
